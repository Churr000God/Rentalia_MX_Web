      ...
      <nav className="sidebar__nav" aria-label="Navegación principal">
        ...
        <div className="sidebar__section">
          ...
          <Link
            ...
            className={`sidebar__link${isComunidadActive ? ' sidebar__link--active' : ''}`}
          >
            <svg
              className="sidebar__link-icon"
              viewBox="0 0 24 24"
          ...
          <Link
            ...
            className={`sidebar__link${isNosotrosActive ? ' sidebar__link--active' : ''}`}
          >
            <svg
              className="sidebar__link-icon"
              viewBox="0 0 24 24"
        ...
        <div className="sidebar__section">
          ...
          <Link
            href="/dashboard/aviso-privacidad"
            className={`sidebar__link${isAvisoPrivacidadActive ? ' sidebar__link--active' : ''}`}
          >
            <svg
              className="sidebar__link-icon"
              viewBox="0 0 24 24"
